...
// End Cross Module References
	...
	static UEnum* TTSDestination_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_TTSDestination.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_VivoxCore_TTSDestination, Z_Construct_UPackage__Script_VivoxCore(), TEXT("TTSDestination"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_VivoxCore_TTSDestination_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_VivoxCore_TTSDestination_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_VivoxCore_TTSDestination_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* TTSMessageState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_TTSMessageState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_VivoxCore_TTSMessageState, Z_Construct_UPackage__Script_VivoxCore(), TEXT("TTSMessageState"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_VivoxCore_TTSMessageState_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_VivoxCore_TTSMessageState_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_VivoxCore_TTSMessageState_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_ITTSMessage_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_ITTSMessage_h_Statics::EnumInfo[] = {
		{ TTSDestination_StaticEnum, TEXT("TTSDestination"), &Z_Registration_Info_UEnum_TTSDestination, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3353038251U) },
		{ TTSMessageState_StaticEnum, TEXT("TTSMessageState"), &Z_Registration_Info_UEnum_TTSMessageState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1393834464U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_ITTSMessage_h_4216248999(TEXT("/Script/VivoxCore"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_ITTSMessage_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_ITTSMessage_h_Statics::EnumInfo));
