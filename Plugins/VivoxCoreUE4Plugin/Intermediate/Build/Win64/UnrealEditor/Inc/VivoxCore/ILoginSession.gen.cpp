...
// End Cross Module References
	...
	static UEnum* LoginState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_LoginState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_VivoxCore_LoginState, Z_Construct_UPackage__Script_VivoxCore(), TEXT("LoginState"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_VivoxCore_LoginState_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_VivoxCore_LoginState_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_VivoxCore_LoginState_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* SubscriptionMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_SubscriptionMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_VivoxCore_SubscriptionMode, Z_Construct_UPackage__Script_VivoxCore(), TEXT("SubscriptionMode"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_VivoxCore_SubscriptionMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_VivoxCore_SubscriptionMode_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_VivoxCore_SubscriptionMode_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* SubscriptionReply_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_SubscriptionReply.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_VivoxCore_SubscriptionReply, Z_Construct_UPackage__Script_VivoxCore(), TEXT("SubscriptionReply"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_VivoxCore_SubscriptionReply_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_VivoxCore_SubscriptionReply_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_VivoxCore_SubscriptionReply_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* TransmissionMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_TransmissionMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_VivoxCore_TransmissionMode, Z_Construct_UPackage__Script_VivoxCore(), TEXT("TransmissionMode"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_VivoxCore_TransmissionMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_VivoxCore_TransmissionMode_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_VivoxCore_TransmissionMode_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ParticipantSpeakingUpdateRate_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ParticipantSpeakingUpdateRate.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_VivoxCore_ParticipantSpeakingUpdateRate, Z_Construct_UPackage__Script_VivoxCore(), TEXT("ParticipantSpeakingUpdateRate"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_VivoxCore_ParticipantSpeakingUpdateRate_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_VivoxCore_ParticipantSpeakingUpdateRate_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_VivoxCore_ParticipantSpeakingUpdateRate_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_ILoginSession_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_ILoginSession_h_Statics::EnumInfo[] = {
		{ LoginState_StaticEnum, TEXT("LoginState"), &Z_Registration_Info_UEnum_LoginState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1699349988U) },
		{ SubscriptionMode_StaticEnum, TEXT("SubscriptionMode"), &Z_Registration_Info_UEnum_SubscriptionMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3198373050U) },
		{ SubscriptionReply_StaticEnum, TEXT("SubscriptionReply"), &Z_Registration_Info_UEnum_SubscriptionReply, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1742205163U) },
		{ TransmissionMode_StaticEnum, TEXT("TransmissionMode"), &Z_Registration_Info_UEnum_TransmissionMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 495131289U) },
		{ ParticipantSpeakingUpdateRate_StaticEnum, TEXT("ParticipantSpeakingUpdateRate"), &Z_Registration_Info_UEnum_ParticipantSpeakingUpdateRate, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1766807829U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_ILoginSession_h_2867160726(TEXT("/Script/VivoxCore"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_ILoginSession_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_ILoginSession_h_Statics::EnumInfo));
