...
// End Cross Module References
	...
	static UEnum* PresenceStatus_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_PresenceStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_VivoxCore_PresenceStatus, Z_Construct_UPackage__Script_VivoxCore(), TEXT("PresenceStatus"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_VivoxCore_PresenceStatus_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_VivoxCore_PresenceStatus_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_VivoxCore_PresenceStatus_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_Presence_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_Presence_h_Statics::EnumInfo[] = {
		{ PresenceStatus_StaticEnum, TEXT("PresenceStatus"), &Z_Registration_Info_UEnum_PresenceStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1521589468U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_Presence_h_3285473635(TEXT("/Script/VivoxCore"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_Presence_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FPSchatTest_Plugins_VivoxCoreUE4Plugin_Source_VivoxCore_Public_Presence_h_Statics::EnumInfo));
